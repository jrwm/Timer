...
function dropdwn(e) {
	...
	if (e == 15) {
		document.getElementById("cubetype").innerHTML = "&nbsp; Skewb";
		miaktivminem(1, 1, 0, 0);
...
function kiir() {
	...
	if (ctype == 1) {
		e = '<div class="kockaKontainer2"><div class="uplayer2">';
		for (var t = 0; t < 4; t++) {
	...
	if (ctype == 3) {
		e = '<div class="kockaKontainer4"><div class="uplayer4">';
		for (var t = 0; t < 16; t++) {
	...
	if (ctype == 4) {
		e = '<div class="kockaKontainer5"><div class="uplayer5">';
		for (var t = 0; t < 25; t++) {
			e = e + '<div class="szin4s' + uly[t] + '"></div>'
		}
	...
	if (ctype == 5) {
		e = '<div class="kockaKontainer6"><div class="uplayer6">';
		for (var t = 0; t < 36; t++) {
	...
	if (ctype == 6) {
		e = '<div class="kockaKontainer7"><div class="uplayer7">';
		for (var t = 0; t < 49; t++) {
			e = e + '<div class="szin6s' + uly[t] + '"></div>'
		}
	...
	if (ctype == 7) {
		e = '<div class="kockaKontainer8"><div class="uplayer8">';
		for (var t = 0; t < 64; t++) {
	...
	if (ctype == 8) {
		e = '<div class="kockaKontainer9"><div class="uplayer9">';
		for (var t = 0; t < 81; t++) {
			e = e + '<div class="szin8s' + uly[t] + '"></div>'
		}
	...
	if (ctype == 9) {
		e = '<div class="kockaKontainer10"><div class="uplayer10">';
		for (var t = 0; t < 100; t++) {
	...
	if (ctype == 10) {
		e = '<div class="kockaKontainer11"><div class="uplayer11">';
		for (var t = 0; t < 121; t++) {
			e = e + '<div class="szin11s' + uly[t] + '"></div>'
		}
	...
	if (ctype == 14) {
		e = '<div class="pyraContainer"><div class="pyraleft">';
	...
	if (ctype == 15) {
		e = '<div class="skewbContainer"><div class="skewbup">';
		e = e + '<div class="skw1 sk1wb' + skb[1] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[2] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[3] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[4] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[5] + '"></div>';
		e = e + '</div><div class="skewbleft">';
		e = e + '<div class="skw1 sk1wb' + skb[6] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[7] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[8] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[9] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[10] + '"></div>';
		e = e + '</div><div class="skewbfront">';
		e = e + '<div class="skw1 sk1wb' + skb[11] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[12] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[13] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[14] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[15] + '"></div>';
		e = e + '</div><div class="skewbright">';
		e = e + '<div class="skw1 sk1wb' + skb[16] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[17] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[18] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[19] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[20] + '"></div>';
		e = e + '</div><div class="skewbback">';
		e = e + '<div class="skw1 sk1wb' + skb[21] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[22] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[23] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[24] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[25] + '"></div>';
		e = e + '</div><div class="skewbdown">';
		e = e + '<div class="skw1 sk1wb' + skb[26] + '"></div>';
		e = e + '<div class="skw2 sk2wb' + skb[27] + '"></div>';
		e = e + '<div class="skw3 sk3wb' + skb[28] + '"></div>';
		e = e + '<div class="skw4 sk4wb' + skb[29] + '"></div>';
		e = e + '<div class="skw5 sk5wb' + skb[30] + '"></div>';
		e = e + "</div></div>"
	}
	if (ctype == 16) {
		e = " "
